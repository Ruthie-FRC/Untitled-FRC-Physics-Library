...
JNIEXPORT jint JNICALL Java_rensim_jni_RenSimJNI_initialize
  (JNIEnv *, jclass) {
  c_doThing();
  return 1;
}

JNIEXPORT jlong JNICALL Java_rensim_jni_RenSimJNI_createWorld
...
JNIEXPORT void JNICALL Java_rensim_jni_RenSimJNI_destroyWorld
  (JNIEnv *, jclass, jlong world_handle) {
  c_rsDestroyWorld(static_cast<unsigned long long>(world_handle));
}

JNIEXPORT jint JNICALL Java_rensim_jni_RenSimJNI_createBody
...
JNIEXPORT jint JNICALL Java_rensim_jni_RenSimJNI_setBodyPosition
...
JNIEXPORT jint JNICALL Java_rensim_jni_RenSimJNI_setBodyLinearVelocity
...
JNIEXPORT jint JNICALL Java_rensim_jni_RenSimJNI_setBodyGravityEnabled
...
JNIEXPORT jint JNICALL Java_rensim_jni_RenSimJNI_setWorldGravity
...
JNIEXPORT jint JNICALL Java_rensim_jni_RenSimJNI_stepWorld
...
JNIEXPORT jint JNICALL Java_rensim_jni_RenSimJNI_getBodyPosition
...
JNIEXPORT jint JNICALL Java_rensim_jni_RenSimJNI_getBodyLinearVelocity
