...
/**
 * @brief Common base arena for 2026-season style field configuration and default ball setup.
 */
class Season2026ArenaBase : public SimulatedArena {
  public:
    /** @brief Constructs the base arena and registers default 2026 field/gamepiece configuration. */
